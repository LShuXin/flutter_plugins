...
class Message {
  ...
  Message(this.messageId, this.guildId, this.userId, this.timestamp, this.content);
  factory Message.fromJson(Map<String, dynamic> json) => _$MessageFromJson(json);

  Map<String, dynamic> toJson() => _$MessageToJson(this);
}

final schema = '{"message_id": "i64","user_id": "i64", "guild_id": "i64", "channel_id": "i64", "timestamp": "date", "content": "text"}';
